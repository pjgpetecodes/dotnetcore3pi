...
echo "|                                                            |"
echo "| It will also create a new .NET Core 3 console application  |"
echo "| named <Hostname of your raspberry pi>_test.                |"
echo "|                                                            |"
...
echo "--------------------------------------------------------------"
echo "|                                                            |"
echo "|                 Creating a Directory for                   |"
echo "|                 .NET Console Application                   |"
echo "|                                                            |"
echo "--------------------------------------------------------------"
echo(

cd c:/
mkdir %pihostname%_test
cd %pihostname%_test

echo(
echo "--------------------------------------------------------------"
echo "|                                                            |"
echo "|                 Creating a Global.Json                     |"
echo "|                                                            |"
echo "--------------------------------------------------------------"
echo(
...
echo       "version": "3.1.409", >> global.json
...
echo             "program": "${workspaceFolder}/bin/Debug/netcoreapp3.1/${workspaceFolderBasename}.dll", >> launch.json
